...
5 个 Stitch 业务 Screen 与 5 个实现壳一一映射，Design System 只提供全局 token 与控件规格，不建立业务壳。映射以 [[../10-UI壳接入清单]] 和 [[../stitch-artifacts/README]] 为准；悬浮窗使用独立 Renderer。Stitch HTML 是第一视觉事实来源，代码/CSS/规范次之，截图只辅助校对；不另设 Product Design Design QA 门禁。
