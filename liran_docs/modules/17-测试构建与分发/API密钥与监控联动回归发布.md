...
## 2026-09-20 REQ-260920 3.5.0 已验证增量

- 新增 V2 比例/覆盖/快照、使用记录首次加载、最近 30 个有效样本、79.99/80.00 阈值、0/2 timer、重启去重和取消路径测试。
- 自动化为 64 个 Vitest 文件/499 项、Electron E2E 14 通过/2 跳过；macOS 源程序、原生通知节奏和挂载 DMG 核心流程通过。
- Windows x64 已完成 NSIS/PE/asar/版本/blockmap/哈希交叉验证，不代表 Windows 真机。提交 `b137f0f5` 已推送 GitHub/Gitee，tag `3.5.0` 和稳定 Release 五项资产均已核验。
