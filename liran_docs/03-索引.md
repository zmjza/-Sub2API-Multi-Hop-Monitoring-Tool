...
- 当前状态：development-and-acceptance 2/2 已完成。goal_status=reclaimed。项目状态：待用户检查。资料归档状态：待归档确认。用户检查回写 UPD-2619：3.1.0 真机更新测试专用版已发布 https://github.com/zmjza/-Sub2API-Multi-Hop-Monitoring-Tool/releases/tag/3.1.0 。待 3.0.1 客户端复测自动更新。未收到“归档”前不启动正式归档。
