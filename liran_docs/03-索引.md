...
- [REQ-260913-connectivity-test](archive/REQ-260913-connectivity-test/任务归档.md)：2026-09-13 已归档。连通性测试、最近 100 条统计、V1/V2 渠道兼容。历史真机结果见 [archive/README.md](archive/README.md)。
- [REQ-260914-channel-status-dual-ui](archive/REQ-260914-channel-status-dual-ui/任务归档.md)：2026-09-14 已归档。V1/V2 双协议渠道状态、按 Key 模型加载、最近 100 条统计与 macOS 源码 Electron 验收。

## 2026-09-15 REQ-260915-channel-status-visual-polish（待用户检查，待归档确认）

- 需求整理源：[REQ-260915-channel-status-visual-polish-需求整理.md](requirements/REQ-260915-channel-status-visual-polish-需求整理.md)
- 正式 PRD：[REQ-260915-channel-status-visual-polish-PRD.md](requirements/REQ-260915-channel-status-visual-polish-PRD.md)
- 评分记录：[REQ-260915-channel-status-visual-polish-评分记录.md](requirements/REQ-260915-channel-status-visual-polish-评分记录.md)
- documentation 目标：[REQ-260915-channel-status-visual-polish-documentation-goal.md](requirements/REQ-260915-channel-status-visual-polish-documentation-goal.md)
- 任务拆分：[REQ-260915-channel-status-visual-polish-task-breakdown.md](requirements/REQ-260915-channel-status-visual-polish-task-breakdown.md)
- documentation 审计：[REQ-260915-channel-status-visual-polish-documentation-audit.md](requirements/REQ-260915-channel-status-visual-polish-documentation-audit.md)
- 目标交接：[REQ-260915-channel-status-visual-polish-goal-transition-1to2.json](requirements/REQ-260915-channel-status-visual-polish-goal-transition-1to2.json)
- 当前范围：渠道状态所有入口统一 18 格与平台分类；API 密钥渠道联动和响应式重构；中转站/OpenCodex 小时筛选；全局新动效；悬浮窗双击进入使用记录；全部站点测试连通性状态动效；站点卡片 /purchase 快捷充值；Sub2API 服务器/雷达/常用网站的安全新页面打开。
- development-and-acceptance 目标：[REQ-260915-channel-status-visual-polish-development-and-acceptance-goal.md](requirements/REQ-260915-channel-status-visual-polish-development-and-acceptance-goal.md)
- 当前状态：development-and-acceptance 2/2 已完成。goal_status=reclaimed。项目状态：待用户检查。资料归档状态：待归档确认。版本 3.0.0。GitHub Release：https://github.com/zmjza/-Sub2API-Multi-Hop-Monitoring-Tool/releases/tag/3.0.0 。修改前评分 86/100，修改后评分 88/100，仍为深度流程；跳过独立 UI 壳。未收到“归档”前不启动正式归档。
...
- RQ-52 OpenCodex 字段展示与筛选：时间、提供方、提供方模型、状态、思考模式、请求类型、Token、缓存率、首字、耗时/t-s、实际消费；服务端 request-history 按范围/提供方/模型/状态分页拉取全部匹配记录，Renderer 再做思考模式/请求类型筛选。
